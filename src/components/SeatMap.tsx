...
export function SeatLegend() {
  return (
    <div className="grid w-fit grid-cols-[repeat(3,max-content)] items-center gap-x-4 gap-y-2 rounded-2xl border border-neutral-100 bg-neutral-50 px-4 py-2.5 text-[11px] font-bold text-neutral-500">
      {LEGEND.map((i) => (
