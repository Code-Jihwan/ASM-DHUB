...
<p align="center">
  <img src="docs/release-note-v1.2.0.png" alt="@@자리요 v1.2.0 릴리스 노트" width="760">
</p>

> 원본 HTML: [`docs/release-note-v1.2.0.html`](docs/release-note-v1.2.0.html) — 브라우저에서 열어 인쇄(PDF 저장)할 수 있습니다.
> 이전 버전: [v1.1.0](docs/release-note-v1.1.0.html) · [v1.0.0](docs/release-note-v1.0.0.html)
